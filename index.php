...
<body>
	...
	<div class="message"><?php if(isset($message)) echo $message; ?></div>
		<ul id="signup-step">
			...
			<li id="StudentExpen">Applicant Expenditures</li>
	...
	<form name="frmRegistration" id="signup-form" method="post" data-persist="garlic" enctype="multipart/form-data">
		...
		*** Family Member Occupation classification
		...
		<div id="StudentExpen-field" style="display:none;">
			<DIV id="outer">
				<DIV id="product6">
					<?php require_once("studentExpenitures.php") ?>
				</DIV>
			</DIV>
		</div>
		...
		<div id="Land-field" style="display:none;">
			<DIV id="outer">
				...
				<DIV class="btn-action float-clear">
					<input  class="btn btn-success" type="button" name="add_item" value="Add More" onClick="addMoreland();" />
					<input class="btn btn-danger" type="button" name="del_item" value="Delete" onClick="deleteRowland();" />
					<span class="success"><?php if(isset($message)) { echo $message; }?></span>
				</DIV>
			</DIV>
		</div>
		...
		<div id="usman-field" style="display:none;">
			<div>
				<h1>Section E:</h1>
				<h2>Applicant Educational Record</h2>
